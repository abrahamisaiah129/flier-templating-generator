              ...
              <div className="absolute top-2 left-2 flex flex-col gap-1 items-start">
                ...
                {isPrimary ? (
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 bg-black/60 hover:bg-[#F26522] text-white text-[9px] font-bold px-1.5 py-0.5 rounded-md transition-all cursor-pointer"
                  >
                    Set Cover
                  </button>
                )}
